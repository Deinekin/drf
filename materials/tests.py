...
class CourseTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson = Lesson.objects.create(name="test", description="test", owner=self.user)
        self.course = Course.objects.create(name='testing', description='testing', owner=self.user)
